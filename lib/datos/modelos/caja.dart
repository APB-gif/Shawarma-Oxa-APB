...
class Caja {
  ...
  Caja copyWith({
    ...
    return Caja(
      ...
      usuarioAperturaNombre: usuarioAperturaNombre ?? this.usuarioAperturaNombre,
  ...
  factory Caja.fromJson(Map<String, dynamic> json) => Caja(
        ...
        fechaCierre: json['fechaCierre'] != null ? _asDate(json['fechaCierre']) : null,
        ...
        cierreReal: json['cierreReal'] != null ? _asDouble(json['cierreReal']) : null,
        diferencia: json['diferencia'] != null ? _asDouble(json['diferencia']) : null,
  ...
  factory Caja.fromFirestore(Map<String, dynamic> data, String docId) {
    return Caja(
      ...
      fechaCierre: data['fechaCierre'] != null ? _asDate(data['fechaCierre']) : null,
      ...
      cierreReal: data['cierreReal'] != null ? _asDouble(data['cierreReal']) : null,
      diferencia: data['diferencia'] != null ? _asDouble(data['diferencia']) : null,
